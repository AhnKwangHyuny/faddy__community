...
const CreationMenuBar = ({imageList} ) => {
    ...
    const handleBackUrl = () => {
        ...
        if(location.pathname === "/snaps") {
            ...
            deleteImageList(imageList).then(response => {
            ...
            <div className="menu__bar__container">
                <div className="frame__menu">
                    <div className="back__icon__wrapper" >
                        <FontAwesomeIcon icon={faAngleLeft} className="back-icon__button"
                    ...
                    <div className="submit-button">완료</div>
                </div>
            </div>
        </header>
    );
